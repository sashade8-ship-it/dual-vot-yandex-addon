...
public class YandexVotBottomSheet {
    private static final Runnable STATUS_REFRESH_CALLBACK =
            YandexVotBottomSheet::refreshStatusIfVisible;
    ...
    public static void show(Context context) {
        try {
            ...
            Logger.printException(() -> "YandexVotBottomSheet show failure", ex);
        }
    }
    ...
    private static void updateVoiceButtonCacheIndicators() {
        ...
        if (sb != null) {
            ...
            String text = str("dualvot_yandex_voice_style_standard") + (cached ? suffix : "");
            sb.setText(text);
        }
        ...
        if (lb != null) {
            ...
            String text = str("dualvot_yandex_voice_style_live") + (cached ? suffix : "");
            lb.setText(text);
        }
    }
    ...
    private static LinearLayout createVoiceStyleButtons(Context context) {
        ...
        Button standardButton = createSegmentedButton(context, str("dualvot_yandex_voice_style_standard"));
        Button liveButton = createSegmentedButton(context, str("dualvot_yandex_voice_style_live"));
